...
export class ConfigService {
   ...
   *
   * @returns {Readonly<any>} 返回只读的应用配置对象
   */
  get appConfig(): Readonly<any> {
   ...
   *
   * @returns {Readonly<any>} 返回只读的数据库配置对象
   */
  get databaseConfig(): Readonly<any> {
   ...
   *
   * @returns {Readonly<any>} 返回只读的Redis配置对象
   */
  get redisConfig(): Readonly<any> {
   ...
   *
   * @returns {Readonly<any>} 返回只读的JWT配置对象
   */
  get jwtConfig(): Readonly<any> {
   ...
   *
   * @returns {Readonly<any>} 返回只读的邮件配置对象
   */
  get emailConfig(): Readonly<any> {
   ...
   *
   * @returns {Readonly<any>} 返回只读的日志配置对象
   */
  get loggingConfig(): Readonly<any> {
   ...
   *
   * @returns {Readonly<any>} 返回只读的系统设置配置对象
   */
  get settingConfig(): Readonly<any> {
   ...
   *
   * @returns {Readonly<any>} 返回只读的Keycloak配置对象
   */
  get keycloakConfig(): Readonly<any> {
